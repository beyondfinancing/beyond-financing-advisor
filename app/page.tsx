...
const COPY = {
  en: {
    ...
    heroSubtext:
      "MultiLender Intelligence™ designed to help organize borrower scenarios, improve early qualification flow, and connect each borrower with the appropriate licensed loan officer for personal review.",
    ...
    positioningTitle: "Built for real borrower conversations",
    positioningItems: [
      "Structured borrower intake",
      "Loan officer routing",
      "AI-guided preliminary dialogue",
  ...
  pt: {
    ...
    heroSubtext:
      "MultiLender Intelligence™ projetado para organizar cenários de clientes, melhorar a qualificação inicial e conectar cada cliente ao loan officer licenciado adequado para análise pessoal.",
    ...
    positioningTitle: "Criado para conversas reais com clientes",
    positioningItems: [
      "Intake estruturado do cliente",
      "Roteamento do loan officer",
      "Diálogo preliminar com IA",
  ...
  es: {
    ...
    heroSubtext:
      "MultiLender Intelligence™ diseñado para organizar escenarios de clientes, mejorar la calificación inicial y conectar a cada cliente con el loan officer con licencia adecuado para revisión personal.",
    languageLabel: "Idioma",
    ...
    positioningTitle: "Diseñado para conversaciones reales con clientes",
    positioningItems: [
      "Intake estructurado del cliente",
      "Enrutamiento del loan officer",
      "Diálogo preliminar con IA",
        ...
        <div className="bf-hero" style={styles.hero}>
          <div className="bf-hero-grid" style={styles.heroGrid}>
            ...
            <div style={styles.heroPanel}>
              <div style={styles.heroPanelTitle}>{t.positioningTitle}</div>
              <div style={styles.heroPanelList}>
                {t.positioningItems.map((item) => (
                  <div key={item} style={styles.heroPanelItem}>
                    <span style={styles.heroPanelDot} />
                    <span>{item}</span>
                  </div>
                ))}
              </div>
