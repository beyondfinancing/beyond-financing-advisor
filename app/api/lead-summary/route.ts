...
function buildFallbackSummary(
  ...
  return {
    ...
    openQuestions: [
      ...
      "Confirm property details, occupancy, assets, and down payment funds.",
    ],
    provisionalPrograms: [
    ...
    recommendedNextStep:
      trigger === "apply"
        ...
        : trigger === "contact"
        ? "Borrower clicked or was directed toward direct loan officer email contact."
    ...
    loanOfficerActionPlan: [
      ...
      "Confirm income, credit, assets, occupancy, and documentation strategy.",
